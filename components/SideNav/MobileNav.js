...
import MobileNavTransition from '../Transition/MobileNavTransition'
...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      <MobileNavTransition isOpen={isOpen}>
        <div className="h-full absolute left-0 top-0 bottom-0 right-0 flex justify-end shadow-lg z-50">
